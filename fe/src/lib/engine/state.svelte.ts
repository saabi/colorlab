		...
		snapshot: createExampleState({
			explorer: {
				...
				theme: {
					...
					controlPoints: [
						{ srgbLin: [0.024480228385336703, 0.9262186913057617, 0.9999999927313268] },
						{ srgbLin: [0.036714088434809, 0.371410867700697, 0.9929784650456935] },
						{ srgbLin: [0.019773900866570944, 0.015738147794074578, 0.2519307529369486] },
						{ srgbLin: [0.9423320345489207, 0.4093936116535837, 0.0075267191446548596] },
						{ srgbLin: [0.6632663753802132, 0.7751983959873612, 0.09314133134117958] },
						{ srgbLin: [0.01266614582855688, 0.21434261293288678, 0.007338187636843589] },
						{ srgbLin: [1.1790694067793928e-9, 0.03254381761989106, 0.00002314589650445967] }
					],
					splineConstraint: 'surface',
					splineSpace: 'oklch',
					steps: 27,
			...
			camera: {
				yaw: -3.5240000000000062,
				pitch: -0.03400000000000158,
